...
export const tabs = {
  ...
  activeTintColor: colors.text_light, // text color active tab
  inactiveTintColor: colors.text_light, // text color inactive tab
  indicatorStyle: { backgroundColor: colors.button_fg }, // active tab highlight top
  showIcon: true,
  showLabel: false,
  style: {
    backgroundColor: colors.background_dark, // background color of tabs
    borderTopColor: colors.background_medium // active tab highlight bottom
  }
};
